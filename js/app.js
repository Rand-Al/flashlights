(() => {
    ...
    slideTo: function (e, t, s, i, n) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!r.support.smoothScroll)
            return (
              I({ swiper: r, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function me(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(fe(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          r.find(fe(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(r), (t.pagination.bullets = i.find(fe(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((r = e.renderFraction
    ...
    i("init", () => {
      ...
      i("click", (e, s) => {
        ...
        if (
          ...
          r.length > 0 &&
          !L(i).hasClass(t.params.pagination.bulletClass)
        ) {
          if (
            t.navigation &&
